...
public class AlbumStatsRecord extends TableRecordImpl<AlbumStatsRecord> implements Record13<Integer, String, String, String, Integer, Long, Integer, Timestamp, Timestamp, Timestamp, Timestamp, Long, Long> {

    private static final long serialVersionUID = 1640195499;
     ...
     */
    @Override
    public Row13<Integer, String, String, String, Integer, Long, Integer, Timestamp, Timestamp, Timestamp, Timestamp, Long, Long> fieldsRow() {
     ...
     */
    @Override
    public Row13<Integer, String, String, String, Integer, Long, Integer, Timestamp, Timestamp, Timestamp, Timestamp, Long, Long> valuesRow() {
     ...
     */
    @Override
    public AlbumStatsRecord value12(Long value) {
        setCount(value);
        return this;
    }
     ...
     */
    @Override
    public AlbumStatsRecord values(Integer value1, String value2, String value3, String value4, Integer value5, Long value6, Integer value7, Timestamp value8, Timestamp value9, Timestamp value10, Timestamp value11, Long value12, Long value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AlbumStatsRecord(Integer id, String name, String description, String path, Integer bannerImageId, Long bannerImagePublicId, Integer parentAlbumId, Timestamp newestImage, Timestamp oldestImage, Timestamp createdOn, Timestamp updatedOn, Long count, Long countPublic) {
        super(AlbumStats.ALBUM_STATS);
