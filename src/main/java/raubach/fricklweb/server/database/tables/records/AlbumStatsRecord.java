...
public class AlbumStatsRecord extends TableRecordImpl<AlbumStatsRecord> implements Record16<Integer, String, String, String, Integer, Long, Integer, Timestamp, Timestamp, Timestamp, Timestamp, Integer, Integer, Integer, Integer, Integer> {

    private static final long serialVersionUID = 1085907369;
     ...
     */
    @Override
    public Row16<Integer, String, String, String, Integer, Long, Integer, Timestamp, Timestamp, Timestamp, Timestamp, Integer, Integer, Integer, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row16<Integer, String, String, String, Integer, Long, Integer, Timestamp, Timestamp, Timestamp, Timestamp, Integer, Integer, Integer, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public AlbumStatsRecord value10(Timestamp value) {
        setCreatedOn(value);
        return this;
    }
     ...
     */
    @Override
    public AlbumStatsRecord value15(Integer value) {
        setAlbumCount(value);
        return this;
    }
     ...
     */
    @Override
    public AlbumStatsRecord value16(Integer value) {
     ...
     */
    @Override
    public AlbumStatsRecord values(Integer value1, String value2, String value3, String value4, Integer value5, Long value6, Integer value7, Timestamp value8, Timestamp value9, Timestamp value10, Timestamp value11, Integer value12, Integer value13, Integer value14, Integer value15, Integer value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AlbumStatsRecord(Integer id, String name, String description, String path, Integer bannerImageId, Long bannerImagePublicId, Integer parentAlbumId, Timestamp newestImage, Timestamp oldestImage, Timestamp createdOn, Timestamp updatedOn, Integer albumId, Integer imageCount, Integer imageCountPublic, Integer albumCount, Integer imageViewCount) {
        super(AlbumStats.ALBUM_STATS);
        ...
        set(11, albumId);
        set(12, imageCount);
        set(13, imageCountPublic);
        set(14, albumCount);
        set(15, imageViewCount);
    }
}
