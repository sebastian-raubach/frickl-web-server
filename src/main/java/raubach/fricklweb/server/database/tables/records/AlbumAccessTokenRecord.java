...
public class AlbumAccessTokenRecord extends TableRecordImpl<AlbumAccessTokenRecord> implements Record6<Integer, String, String, Integer, String, Timestamp> {
    ...
    public AlbumAccessTokenRecord(Integer albumId, String albumName, String albumDescription, Integer tokenId, String tokenToken, Timestamp tokenExpiresOn) {
        ...
        setTokenId(tokenId);
        setTokenToken(tokenToken);
        setTokenExpiresOn(tokenExpiresOn);
    }

    /**
     * Create a detached, initialised AlbumAccessTokenRecord
     */
    public AlbumAccessTokenRecord(raubach.fricklweb.server.database.tables.pojos.AlbumAccessToken value) {
        super(AlbumAccessToken.ALBUM_ACCESS_TOKEN);

        if (value != null) {
            setAlbumId(value.getAlbumId());
            setAlbumName(value.getAlbumName());
            setAlbumDescription(value.getAlbumDescription());
            setTokenId(value.getTokenId());
            setTokenToken(value.getTokenToken());
            setTokenExpiresOn(value.getTokenExpiresOn());
        }
    }
}
