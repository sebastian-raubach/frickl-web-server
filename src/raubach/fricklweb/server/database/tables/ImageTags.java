...
public class ImageTags extends TableImpl<ImageTagsRecord>
{
	...
	private static final long                                 serialVersionUID = -1696198153;
	/**
	 * The column <code>frickl.image_tags.image_id</code>.
	 */
	public final         TableField<ImageTagsRecord, Integer> IMAGE_ID         = createField("image_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
	/**
	 * The column <code>frickl.image_tags.tag_id</code>.
	 */
	public final         TableField<ImageTagsRecord, Integer> TAG_ID           = createField("tag_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
