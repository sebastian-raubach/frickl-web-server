...
public class ImagesRecord extends UpdatableRecordImpl<ImagesRecord> implements Record6<Integer, String, Exif, Integer, Timestamp, Timestamp>
{

	private static final long serialVersionUID = -509050613;
	 ...
	 */
	public ImagesRecord(Integer id, String path, Exif exif, Integer albumId, Timestamp createdOn, Timestamp updatedOn)
	{
		super(Images.IMAGES);
	 ...
	 */
	@Override
	public Row6<Integer, String, Exif, Integer, Timestamp, Timestamp> fieldsRow()
	{
	 ...
	 */
	@Override
	public Row6<Integer, String, Exif, Integer, Timestamp, Timestamp> valuesRow()
	{
	 ...
	 */
	@Override
	public ImagesRecord value3(Exif value)
	{
		setExif(value);
		return this;
	}
	 ...
	 */
	@Override
	public ImagesRecord values(Integer value1, String value2, Exif value3, Integer value4, Timestamp value5, Timestamp value6)
	{
		value1(value1);
		value2(value2);
		value3(value3);
