...
public class Albums extends TableImpl<AlbumsRecord>
{
	 ...
	 */
	public final         TableField<AlbumsRecord, Integer>   ID               = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
	/**
	 * The column <code>frickl.albums.name</code>.
	 */
	 ...
	 */
	public final         TableField<AlbumsRecord, Integer>   BANNER_IMAGE_ID  = createField("banner_image_id", org.jooq.impl.SQLDataType.INTEGER, this, "");
	/**
	 * The column <code>frickl.albums.parent_album_id</code>.
	 */
	public final         TableField<AlbumsRecord, Integer>   PARENT_ALBUM_ID  = createField("parent_album_id", org.jooq.impl.SQLDataType.INTEGER, this, "");
	/**
	 ...
	 */
	public final         TableField<AlbumsRecord, Timestamp> UPDATED_ON       = createField("updated_on", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
