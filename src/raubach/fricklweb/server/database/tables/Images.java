...
public class Images extends TableImpl<ImagesRecord>
{
    ...
    private static final long                                serialVersionUID = -491668332;
    /**
    ...
    /**
     * The column <code>frickl.images.name</code>.
     */
    public final         TableField<ImagesRecord, String>    NAME             = createField("name", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
    /**
