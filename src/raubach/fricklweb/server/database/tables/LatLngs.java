...
public class LatLngs extends TableImpl<LatLngsRecord>
{
	...
	private static final long                                  serialVersionUID = 1980275178;
	/**
	 * The column <code>frickl.lat_lngs.id</code>.
	 */
	public final         TableField<LatLngsRecord, Integer>    ID               = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
	/**
	 * The column <code>frickl.lat_lngs.path</code>.
	 */
	public final         TableField<LatLngsRecord, String>     PATH             = createField("path", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
	/**
	 * The column <code>frickl.lat_lngs.album_id</code>.
	 */
	public final         TableField<LatLngsRecord, Integer>    ALBUM_ID         = createField("album_id", org.jooq.impl.SQLDataType.INTEGER, this, "");
	/**
